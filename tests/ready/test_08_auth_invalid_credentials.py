...
def test_08_auth_invalid_credentials(page: Page):
    ...
    # Заполняем поле Порт невалидным значением (заодно проверяем ввод очень большого числа)
    port_input.fill('99999999999999999999999')
